  ...
  return (
    ...
    <div className="flex justify-center items-center h-screen">
      ...
      <div className="w-[300px] lg:w-[430px] 2xl:w-[630px] h-[370px] 2xl:h-[550px] p-8 2xl:p-10 bg-gray-100 border rounded-[45px] shadow-gray-300 shadow-[10px_10px_10px_rgba(0,0,0,0.25),inset_1px_1px_10px_rgba(0,0,0,5)] ">
        ...
        <div className="cursor-pointer p-2 2xl:p-4 my-5 2xl:my-8 bg-indigo-500 text-white text-center rounded-lg shadow-lg shadow-indigo-500/50 hover:shadow-indigo-600/70 hover:shadow-[inset_10px_10px_10px]">
          로그인
        </div>
        ...
        <div className="cursor-pointer p-2 2xl:p-4 my-5 2xl:my-8 bg-white text-center rounded-lg shadow-gray-300/50 hover:shadow-indigo-300/50 shadow-[inset_3px_3px_3px_rgba(0,0,0,5)] hover:shadow-[10px_10px_10px,inset_1px_1px_5px]">
          회원가입
        </div>
      </div>
    </div>
